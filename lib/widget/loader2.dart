...
class LoaderTwo extends StatefulWidget {
  ...
  LoaderTwo({Key key, this.centralDotColor = UIData.Bassic,
      //Colors.black26,
    this.dotOneColor=UIData.Bassic,
    this.dotTwoColor=UIData.Bassic,
    this.dotThreeColor=UIData.Bassic,
    this.dotFourColor=UIData.Bassic,
    this.dotFiveColor=UIData.Bassic,
    this.dotSixColor=UIData.Bassic,
    this.dotSevenColor=UIData.Bassic,
    this.dotEightColor=UIData.Bassic,
    this.centralDotRadius=15.0,
    this.spanRadius=15.0, this.duration = const Duration(seconds: 2), this.outerDotRadius = 5.0 }) : super(key: key);
