                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("Valido hasta FECHA",style: TextStyle(color: Colors.grey),),
                      Align(child: Text("Canjear",style: TextStyle(color: UIData.PrimaryColor,fontSize: 15,fontWeight: FontWeight.bold),), alignment: Alignment.centerRight),
                    ],
                  ),
                ),
              )
            ...
            Padding(
              ...
              child: TextField(
                decoration: InputDecoration(
                    ...
                    hintText: "Ingresa tu codigo Promocional",
